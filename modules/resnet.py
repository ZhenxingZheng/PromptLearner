...
import selective_kernel_position_3d
...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
        ...
        self.aggregation = selective_kernel_position_3d.Kernel_Position(frame=16)
    ...
    def forward(self, x):
        ...
        x1 = self.layer1(x)
        x2 = self.layer2(x1) # [2, 128, 4, 28, 28]
        x3 = self.layer3(x2) # [2, 256, 2, 14, 14]
        x4 = self.layer4(x3) # [2, 512, 1, 7, 7]

        x4 = self.aggregation(x2, x3, x4)
